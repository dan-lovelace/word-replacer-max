⚠️ This is a subset of the Word Replacer Max browser extension source code and
cannot be built without the core libraries. See our
[contribution guidelines](./CONTRIBUTING) for more details.
