  ...
  return (
    <Container>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Word Replacer Max, the
      ...
      <ul>
        <li>
          <p>
            <strong>AWS Simple Email Service</strong>
          </p>
          <p>
      ...
      <p>
        ...
        for activities such as advertising, marketing, and analytics, and these
        may be deemed a sale under CCPA/CPRA.
      </p>
      <p>
      ...
      <ul>
        <li>By email: hello@wordreplacermax.com</li>
      </ul>
      <p>
      ...
      <p>
        ...
        preferences and opt out of cookies and other technologies that We may
      ...
      <p>
        ...
        served by our Service Providers by following our instructions presented
        on the Service:
      </p>
      <ul>
        <li>
