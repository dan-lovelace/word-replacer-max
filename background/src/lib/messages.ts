...
import { getApiEndpoint } from "@web-extension/shared/src/api";
import { browser } from "@web-extension/shared/src/browser";
import { processReplacements } from "@web-extension/shared/src/service-worker";
import { authStorageProvider } from "@web-extension/shared/src/storage";
import { ApiAuthTokens } from "@wordreplacermax/types/src/api";
import { IdentificationError } from "@wordreplacermax/types/src/identity";
import {
  RuntimeMessage,
  RuntimeMessageKind,
  WebAppMessageData,
