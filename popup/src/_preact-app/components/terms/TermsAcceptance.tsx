...
import { getTermsNeedAcceptance } from "@web-extension/shared/src/permission";
import { TERMS_AND_CONDITIONS_URL } from "@web-extension/shared/src/support";
import { ApiResponse } from "@wordreplacermax/types/src/api";
import {
  ApiAuthAcceptTermsRequest,
  ApiAuthAcceptTermsResponse,
} from "@wordreplacermax/types/src/api/auth";
