...
import { getAccessToken } from "@web-extension/shared/src/browser";
import {
  DEFAULT_TONE_OPTION,
  toneOptions,
} from "@web-extension/shared/src/replace/lib/suggest";
import { localStorageProvider } from "@web-extension/shared/src/storage";
import {
  ApiResponse,
  ApiSuggestRequest,
  ApiSuggestResponse,
} from "@wordreplacermax/types/src/api";
import { PopupAlertSeverity } from "@wordreplacermax/types/src/popup";
