...
import { debounce } from "@web-extension/shared";
import {
  DEFAULT_RENDER_RATE_MS,
  MAX_RENDER_RATE_MS,
  MIN_RENDER_RATE_MS,
} from "@web-extension/shared/src/replace/lib/render";
import { storageSetByKeys } from "@web-extension/shared/src/storage";
import { RenderRate as TRenderRate } from "@wordreplacermax/types/src/rules";
