...
import { POPUP_DEV_SERVER_PORT } from "@web-extension/testing/src/popup";
import { Environment } from "@wordreplacermax/types/src/config";
...
const productionConfig: UserConfig = {
  ...
  plugins: [buildConfig(), preact(), react()],
};
